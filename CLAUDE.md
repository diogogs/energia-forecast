...
- [ ] **Camadas clean + features** — grelha horária, pivot das séries REN/EC, AsOfRepo (t_issue explícito). **Início da lógica de modelação** (reler "Modelo temporal" antes de tocar em `src/features`).
