...
- [ ] **Amanhã: observar a 1ª emissão pontual** — crons com retry tickets (ingest 06:30/07:45; predict 07:05/07:50/08:35) → primeira emissão `late_issue=False` → painel "Today: forecast vs actuals" enche sozinho. Critério W2: 3+ dias sem intervenção.
